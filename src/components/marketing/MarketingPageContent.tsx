        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 tracking-tight">
              Who Uses <span className="text-indigo-600">TempestIQ</span>
            </h2>
          ...
          <div className="mt-16 flex justify-center w-full">
            ...
            <p className="text-gray-700 mb-4">
              Generate verification reports that prove storm impact at any address. Insurance-grade documentation, damage timelines, and severity scoring—so you close more deals with evidence in hand.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-10">
            ...
            <div className="min-w-0">
              ...
              <ul className="space-y-2.5 text-sm text-slate-300">
                <li><a href="#solutions" className="hover:text-indigo-400 transition-colors">Who Uses TempestIQ</a></li>
                <li><a href="#why-ai" className="hover:text-indigo-400 transition-colors">Why AI</a></li>
                <li><a href="#features" className="hover:text-indigo-400 transition-colors">Features</a></li>
                <li><a href="#proof" className="hover:text-indigo-400 transition-colors">Proof</a></li>
